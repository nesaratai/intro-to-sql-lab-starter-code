...
SELECT name FROM countries
    LEFT JOIN countrylanguages ON countrycode = countries.code
...
-- Write SQL query here
SELECT cities.name, countries.name AS country FROM countries
JOIN cities ON countrycode = countries.code
...
-- Write SQL query here
SELECT countries.name AS country, cities.name AS capital FROM countries
...
SELECT cities.name, countries.name AS country, cities.population FROM cities
    JOIN countries ON cities.countryCode = countries.Code
    WHERE countries.region = 'South America'
        AND cities.population BETWEEN 91000 AND 91090;